...
<head>
    ...
    <title><g:message code="categoria.create.label" args="[entityName]" default="Nuovo"/></title>
</head>
<body>
...
<div id="create-categoria" class="content scaffold-create" role="main">
    <h1><g:message code="categoria.create.label" args="[entityName]" default="Nuovo"/></h1>
