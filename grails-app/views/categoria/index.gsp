...
<div id="list-categoria" class="content scaffold-list" role="main">
    ...
    <div class="pagination">
        <g:if test="${usaFilter}">
            <filterpane:paginate total="${categoriaInstanceCount}" domainBean="Categoria"/>
            <filterpane:filterButton text="Seleziona un filtro" appliedText="Cambia il filtro"/>
            <filterpane:isNotFiltered>Mostrati tutti i ${categoriaInstanceCount} records</filterpane:isNotFiltered>
            <filterpane:isFiltered>Mostrati ${categoriaInstanceCount} records su ${categoriaInstanceTotal}</filterpane:isFiltered>
        </g:if>
        <g:else>
