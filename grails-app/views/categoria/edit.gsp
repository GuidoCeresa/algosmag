...
<head>
    ...
    <title><g:message code="categoria.edit.label" args="[entityName]" default="Modifica"/></title>
</head>
<body>
...
<div id="edit-categoria" class="content scaffold-edit" role="main">
    <h1><g:message code="categoria.edit.label" args="[entityName]" default="Aggiungi"/></h1>
