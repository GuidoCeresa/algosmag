...
<div id="list-unita" class="content scaffold-list" role="main">
    ...
    <div class="pagination">
        <g:if test="${usaFilter}">
            <filterpane:paginate total="${unitaInstanceCount}" domainBean="Unita"/>
            <filterpane:filterButton text="Seleziona un filtro" appliedText="Cambia il filtro"/>
            <filterpane:isNotFiltered>Mostrati tutti i ${unitaInstanceCount} records</filterpane:isNotFiltered>
            <filterpane:isFiltered>Mostrati ${unitaInstanceCount} records su ${unitaInstanceTotal}</filterpane:isFiltered>
        </g:if>
        <g:else>
            <g:paginate total="${unitaInstanceTotal}"/>
        </g:else>
    </div>
    <filterpane:filterPane domain="Unita"/>
